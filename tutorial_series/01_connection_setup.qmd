...
ribbitr.dbname = "[DATABASE-HERE]"
ribbitr.host = "[HOST-HERE]"
ribbitr.port = "[PORT-HERE]"
...
![Enter your database credentials as shown above, substituting the database name, host, port, your user and password.](images/DBeaver_connection_setup_02.png)
