...
## Pivot wider
We have our data! Taking a closer look, we find our temperature data in the column `temperature_c`.
...
[\<- 5. Bd-Capture Workflow](05_bd_capture_workflow.html) \|  [7. Sample Results and Controls -\>](07_samples_controls.html)
</div>