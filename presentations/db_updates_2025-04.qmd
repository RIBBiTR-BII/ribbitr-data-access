---
title: "RIBBiTR Database Updates"
format: revealjs
editor: source
---
...
## Databases in collaborative research
![Information cycle, from field to database and (hopefully) back...](db_updates_2025-04/basic_layout2.png){fig-alt="Information flows cyclically from frogs to humans, to computers, apps, and databases, and then back to humans and (hopefully) frogs" fig-align="center" width="600"}

## Databases in collaborative research
![But critical context is lost along the way!](db_updates_2025-04/need_layout2.png){fig-alt="Context is lost as we move towards the database, and context is needed as we move back toward the field." fig-align="center" width="600"}

## Databases in collaborative research
![Transmission of context at each step is key to acting with informed, relevant insight.](db_updates_2025-04/context_layout2.png){fig-alt="Context can be transmitted through shared experiences, conversations, meetings, calls, emails, and code sharing." fig-align="center" width="600"}
...
## Data in our community
![](db_context_images/poll_platforms.png){fig-alt="What data platforms do you use with RIBBiTR data?" fig-align="center" width="600"}

## Data in our community
![](db_context_images/poll_data_products.png){fig-alt="What data products interest you in your research?" fig-align="center" width="600"}

## Data in our community
![What emotions come up for you when you read the word 'data'?](db_context_images/poll_emotions_wordcloud.png){fig-alt="What emotions come up for you when you read the word 'data'" fig-align="center" width="600"}


## Closing the loop
![](db_context_images/circular_connected.png){fig-alt="Database connected to apps, computer, people, and frogs / Bd, forming a circle, with connectors" fig-align="center" width="600"}
